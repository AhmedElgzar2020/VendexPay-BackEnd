...
namespace Vendexpay.API.Migrations
{
    ...
    [Migration("20210804094650_AddVendorDocumentsModels")]
    partial class AddVendorDocumentsModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vendexpay.Model.Balaiya", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vendexpay.Model.ComputerCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vendexpay.Model.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vendexpay.Model.Balaiya", b =>
                {
                    b.HasOne("Vendexpay.Model.Document", "Document")
                        .WithOne("Balaiya")
                        .HasForeignKey("Vendexpay.Model.Balaiya", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vendexpay.Model.CR", b =>
                {
                    b.HasOne("Vendexpay.Model.Document", "Document")
                        .WithOne("CR")
                        .HasForeignKey("Vendexpay.Model.CR", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vendexpay.Model.ComputerCard", b =>
                {
                    b.HasOne("Vendexpay.Model.Document", "Document")
                        .WithOne("ComputerCard")
                        .HasForeignKey("Vendexpay.Model.ComputerCard", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vendexpay.Model.ComputerCardAuthorizer", b =>
                {
                    b.HasOne("Vendexpay.Model.Document", "Document")
                        .WithMany("computerCardAuthorizers")
            ...
            modelBuilder.Entity("Vendexpay.Model.Document", b =>
                {
                    b.HasOne("Vendexpay.Model.Vendor", "Vendor")
                        .WithOne("Document")
                        .HasForeignKey("Vendexpay.Model.Document", "VendorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vendexpay.Model.Marchant", b =>
                {
                    ...
                    b.HasOne("Vendexpay.Model.Vendor", "Vendor")
                        .WithOne("Marchant")
                        .HasForeignKey("Vendexpay.Model.Marchant", "VendorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vendexpay.Model.Document", b =>
                {
                    b.Navigation("Balaiya");

                    b.Navigation("ComputerCard");

                    b.Navigation("computerCardAuthorizers");
